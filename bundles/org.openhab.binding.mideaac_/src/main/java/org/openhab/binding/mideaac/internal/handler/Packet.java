...
public class Packet {
    ...
    public Packet(CommandBase command, String deviceId) {
    ...
    public void finalize() {
        ...
        byte[] cmdEncrypted = Security.aes_encrypt(command.getBytes());
        ...
        packet = ArrayUtils.addAll(packet, Security.encode32_data(packet));
    }
